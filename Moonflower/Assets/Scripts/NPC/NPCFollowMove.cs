...
public class NPCFollowMove : MonoBehaviour, IMovement//, INPCMovement
{
    ...
    public NPCFollowMove(GameObject selfOb, GameObject playerOb)
    {
    ...
    public NPCFollowMove(GameObject selfOb, GameObject playerOb, Vector3 wanderOrigin, float wanderRadius)
    {
        commonSetup(selfOb, playerOb);
        canWander = true;
        wandering = true;
    ...
    public NPCFollowMove(GameObject selfOb, GameObject playerOb, Vector3 wanderOrigin, float wanderRadius, float maxEngagementDistance)
    {
        commonSetup(selfOb, playerOb);
    ...
    public NPCFollowMove(GameObject selfOb, GameObject playerOb, float maxEngagementDistance)
    {
        commonSetup(selfOb, playerOb);
